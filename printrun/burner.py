...
class PronterWindow(MainWindow, pronsole.pronsole):
    ...
    def __init__(self, app, filename = None, size = winsize):
        ...
        MainWindow.__init__(self, None, title = _("Burner"), size = size)
    ...
    def create_menu(self):
        ...
        self.Bind(wx.EVT_MENU, self.about,
                  m.Append(-1, _("&About Burner"), _("Show about dialog")))
    ...
    def about(self, event):
        ...
        licence = "Burner is free software: you can redistribute it and/or modify it under the "
        licence += " terms of the GNU General Public License as published by the Free Software Foundation, either"
        licence += " version 3 of the License, or (at your option) any later version.\n"
        licence += "Burner is distributed in the hope that it will be useful, but WITHOUT ANY "
        licence += "WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A "
        licence += "PARTICULAR PURPOSE.  See the GNU General Public License for more details. \n"
        licence += "You should have received a copy of the GNU General Public License along with"
        licence += "Printrun. If not, see <http://www.gnu.org/licenses/>."
